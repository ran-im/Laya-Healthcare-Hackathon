      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12"
        ...
        <div>
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-sm">
            Create your account to start submitting claims, checking your benefits,
            and getting decisions in minutes.
          </p>

          <div className="mt-10 space-y-4">
            {[
              '✓ Submit claims from your phone or desktop',
              '✓ Real-time claim status tracking',
              '✓ AI-powered instant benefit checks',
        ...
        <div className="w-full max-w-md py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1 text-sm">
              ...
              <a href="/login" className="font-semibold" style={{ color: '#00A89D' }}>
                Sign in
              </a>
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
              <input type="checkbox" required id="consent"
                className="mt-0.5 rounded accent-teal-600 cursor-pointer" />
              <label htmlFor="consent" className="text-xs text-gray-600 cursor-pointer">
                I confirm the information provided is correct and I consent to Laya Healthcare
                processing my personal and medical data for claim handling purposes, in accordance
                with our{' '}
                <a href="/privacy" className="underline" style={{ color: '#00A89D' }}>
                  Privacy Policy
                </a>{' '}
